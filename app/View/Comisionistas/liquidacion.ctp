				...
				<div class="card">
					...
					<div class="card-body p-t-15">
						...
						<table class="table table-striped table-bordered m-t-15">
							<thead>
								<tr>
									<th class="no-print" style="width: 50px; text-align: center;"><input type="checkbox" id="checkAll" checked></th>
									<th>Usuario</th>
									<th>Jugador</th>
								...
								<?php foreach($jugadores_agencia as $jug): ?>
									<tr>
										<td class="no-print" style="text-align: center;">
											<input type="checkbox" class="jugador-checkbox" name="jugadores[]" value="<?= $jug['id'] ?>" data-saldo="<?= $jug['saldo'] ?>" checked>
										</td>
										<td><?= $jug['usuario'] ?></td>
										<td><?= $jug['nombre'] ?></td>
										...
										<td style="text-align: right; <?= $jug['saldo'] > 0 ? 'color: red;' : ($jug['saldo'] < 0 ? 'color: green;' : '') ?>">
						...
						<div class="row m-t-30">
							<div class="col-md-6 offset-md-6">
								<div class="totales-box">
									<div class="row">
										<div class="col-8 text-right"><strong>Subtotal Jugadores:</strong></div>
										<div class="col-4 text-right"><strong id="lbl_subtotal_jugadores">$0.00</strong></div>
									</div>
									<div class="row m-t-10">
										<div class="col-8 text-right"><strong>Total Comisiones Agencia:</strong></div>
										<div class="col-4 text-right"><strong style="color: blue;">$<?= number_format($total_comision, 2) ?></strong></div>
									</div>
									<hr>
									<div class="row">
										<div class="col-8 text-right"><strong>GRAN TOTAL NETO:</strong></div>
										<div class="col-4 text-right"><strong id="lbl_gran_total" style="font-size: 1.5em;">$0.00</strong></div>
									</div>
									<div class="row m-t-10">
				...
				<div class="card">
					...
					<div class="card-body p-t-15">
						<div class="alert alert-warning">
							<i class="fa fa-warning"></i> Al procesar la liquidación, los saldos de los jugadores seleccionados y las comisiones pendientes se volverán a poner en $0.
						</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group checkbox_basic_swithes_padbott m-t-20">
									<label>
										<input type="checkbox" name="data[Liquidacion][reflejar_banco]" id="reflejar_banco" value="1" class="make-switch-radio" data-on-color="success" data-off-color="danger" onchange="toggleBanco()">
										Reflejar en Banco
									</label>
								</div>
							</div>
							...
							<div class="col-md-4 text-right">
								<button type="submit" class="btn btn-success btn-lg m-t-20" onclick="return confirm('¿Estás seguro de procesar esta liquidación y poner en cero los saldos?');">
